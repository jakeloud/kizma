...
'api/file':{fn:a_file, schema: {"relativePath":"a/file.ts","apiPath":"api/file","safeFullModuleName":"a_file"}}`)});var nt=async(e,t,o,n)=>{let a=await P(e),i=await k(o),s=a.map(({filePath:c,relativePath:l,fileName:f})=>{let m=A(c),S=l.replaceAll(/(\/|\.)/g,"_"),b={filePath:c,relativePath:l,safeFullModuleName:S,moduleName:f,apiPath:`/${e}/${l}`,formId:`/${e}/${l}`,outFile:(0,g.resolve)(t,`${l}.html`)};return Object.assign(m,b)});if(n){let c=(0,g.resolve)(t);await(0,u.rm)(c,{force:!0,recursive:!0}),await(0,u.mkdir)(c,{recursive:!0});let l=s.map(m=>(async()=>{let b=E({templates:i,schema:m}),w=m.outFile,_=(0,g.parse)(w).dir;try{await stat(_)}catch{await(0,u.mkdir)(_,{recursive:!0})}await(0,u.writeFile)(w,b)})()),f=[{templateName:"client",relativeOutFile:"client.js"},{templateName:"styles",relativeOutFile:"styles.css"}].map(({templateName:m,relativeOutFile:S})=>(async()=>{let w=i[m].content,_=(0,g.resolve)(t,S),T=(0,g.parse)(_).dir;try{await stat(T)}catch{await(0,u.mkdir)(T,{recursive:!0})}await(0,u.writeFile)(_,w)})());await Promise.all(l.concat(f))}let r=C({templates:i,schemas:s,inDir:e,outDir:t});return await j.build({stdin:{contents:r,resolveDir:".",sourcefile:"server.ts",loader:"ts"},bundle:!0,platform:"node",outfile:"server.cjs",external:["dotenv"]}),r},M=nt;var at=e=>{let t=[],o=[];for(let n of e)n.startsWith("-")?n.substring(1).split("").forEach(a=>t.push(a)):o.push(n);return{modifiers:t,values:o}},rt=e=>{let t="public",o="templates",n="api",a=at(e.splice(2)),i=a.modifiers.includes("f"),s=a.modifiers.filter(l=>l!=="f"),r=a.values;for(let l of s)switch(l){case"o":t=r.shift();break;case"t":o=r.shift();break;default:throw new Error(`Unknown modifier: -${l}`)}return r[0]&&(n=r[0]),[n,t,o,i]},O=rt;var st=O(process.argv);M(...st);
